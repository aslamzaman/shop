...
const Dashboard = () => {
    return (
        <div className="w-full mt-6" >
            ...
            <h1 className="w-full py-4 text-xl lg:text-4xl font-bold text-center text-blue-700 leading-6">SHOPDATABASE<br /> <span className="text-xl text-blue-400">Super-easy storage system</span></h1>

<p className="text-center text-lg text-green-800 animate-pulse">No need to write notes again and again. You will find all your accounting calculations here.</p>

<div className="w-full h-[1px] my-6 bg-gray-600"></div>
