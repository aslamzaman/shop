...
const Dashboard = () => {
    return (
        <div className="w-full mt-6">
            ...
            <h1 className="w-full py-4 text-xl lg:text-4xl font-bold text-center text-blue-700 leading-6">SHOPDATABASE<br /> <span className="text-xl text-blue-400">Supper Easy Storage</span><br /><span className="text-sm text-green-500 animate-pulse">You don't need a shop note book. We provide all your accounts.</span></h1>
