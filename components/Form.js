...
export const BtnEnSm = ({ Title, Click, Class }) => {
  return (
    <button onClick={Click} className={`text-center mt-3 mx-0.5 px-4 py-2 text-sm font-semibold rounded-md focus:ring-1 ring-blue-200 ring-offset-2 duration-300 cursor-pointer text-white ${Class}`}>{Title}</button>
  )
}
...
export const BtnSubmit = ({ Title, Class }) => {
  return (
    <button type="submit" className={`text-center mt-3 mx-0.5 px-4 py-2 font-semibold rounded-md focus:ring-1 ring-blue-200 ring-offset-2 cursor-pointer duration-300 ${Class}`}>{Title}</button>
  )
}

export const BtnSubmitSm = ({ Title, Class }) => {
  return (
    <button type="submit" className={`text-xs text-center mx-0.5 px-2 py-0.5 font-semibold rounded-md focus:ring-1 ring-blue-200 ring-offset-2 cursor-pointer duration-300 ${Class}`}>{Title}</button>
  )
}
